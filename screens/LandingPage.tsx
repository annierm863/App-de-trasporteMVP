      ...
      <div className="relative z-10 flex h-full flex-col justify-between px-6 py-8 md:py-12 max-w-md mx-auto w-full">
        ...
        <div className="flex flex-col items-center w-full space-y-8 mb-8">
          ...
          <div className="w-full pt-2">
            <Link to="/login" className="group w-full flex items-center justify-center rounded-lg bg-primary h-[56px] px-6 text-[#181611] text-lg font-bold leading-normal tracking-wide shadow-[0_0_20px_-5px_rgba(244,192,37,0.3)] hover:shadow-[0_0_25px_-5px_rgba(244,192,37,0.5)] hover:bg-[#ffcd38] active:scale-[0.99] transition-all duration-300">
            ...
            <div className="mt-6 flex justify-center">
              <Link to="/login" className="text-sm font-medium text-white/40 hover:text-primary transition-colors flex items-center gap-1">
