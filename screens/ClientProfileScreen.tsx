    ...
    <div className="bg-background-dark text-white font-display antialiased min-h-screen">
      <div className="relative flex h-full min-h-screen w-full flex-col overflow-x-hidden pb-24 max-w-md mx-auto">
        ...
        <div className="flex flex-col mt-8 px-4 gap-3 max-w-[480px] w-full mx-auto">
          <Link to="/client/service-info" className="flex items-center justify-between p-4 bg-input-bg/50 rounded-xl active:bg-input-bg transition-colors border border-white/5">
          ...
          <Link to="/client/terms" className="flex items-center justify-between p-4 bg-input-bg/50 rounded-xl active:bg-input-bg transition-colors border border-white/5">
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center size-8 rounded-full bg-white/10 text-white">
        ...
        <div className="mt-auto px-4 pt-8 pb-4 w-full max-w-[480px] mx-auto flex flex-col items-center gap-4">
          <Link to="/login" className="flex items-center gap-2 px-6 py-2 text-rose-400 text-sm font-semibold rounded-lg hover:bg-rose-500/10 transition-colors">
