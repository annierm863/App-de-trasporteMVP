          ...
          <div className="rounded-xl bg-[#2e291b] shadow-none p-5 flex flex-col gap-6">
            <div className="grid grid-cols-[32px_1fr] gap-x-3">
              ...
              <div className="flex flex-col pb-6">
                <p className="text-white text-base font-semibold leading-tight">123 Luxury Lane</p>
                <p className="text-text-subtle text-sm mt-0.5">Beverly Hills, CA</p>
              ...
              <div className="flex flex-col">
                ...
                <p className="text-text-subtle text-sm mt-0.5">Los Angeles International Airport</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { label: 'Passengers', val: '2 People', icon: 'group' },
                { label: 'Reference', val: '#BK-8392', icon: 'tag' }
              ].map((item) => (
                <div key={item.label}>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-start">
                    <div>
                      <h4 className="text-white font-bold text-base truncate">James Anderson</h4>
                  ...
                  <div className="mt-3 p-3 bg-[#221e10] rounded-lg flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-xs text-text-subtle">
                        <span>Black</span><span className="size-1 rounded-full bg-gray-400"></span><span className="bg-white/10 px-1.5 py-0.5 rounded text-gray-300 font-mono">LUX-555</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div>
            ...
            <div className="rounded-xl bg-[#2e291b] shadow-none p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-white text-lg font-bold">$145.00</span>
              </div>
